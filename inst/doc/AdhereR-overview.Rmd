...
For more info, please see the vignette [AdhereR: Interactive plotting (and more) with Shiny](https://htmlpreview.github.io/?https://github.com/ddediu/AdhereR/blob/master/online-only-doc/adherer_interactive_plots/adherer_interctive_plots.html) (please note that due to size resrictions, this vignette is not available offline).
